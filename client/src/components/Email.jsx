...
// wrapper to wrap the box in style
// cursor pointer changes to hand on surfing over the text
...
const Email = ({ email, setStarredEmail, selectedEmails, setSelectedEmails }) => {
    ...
    return (
        ...
        </Wrapper>   // here the props passed from emails are used here to show the things (display the emails to user)
          // above date is used, first line gives the date and second line gives the month
    )
}
